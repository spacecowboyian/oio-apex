 ...
 * Extracted from the "#6 Run HUD" backlog proof-out, same as `LeaderboardRow`
 * was, so the HUD and the real per-run cone-hit indicator (rowCells.tsx's
 * `nameCell`) render the identical glyph. That sketch story has since been
 * deleted — the shipped components are the design of record. */
