...
3. Any component work under `video-components/` reads brand values from `tokens.json`, never re-derives a color/type/spacing value by eyeballing the HTML guide.
