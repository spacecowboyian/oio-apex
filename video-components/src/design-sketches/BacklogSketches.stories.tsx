...
/** the actual supplied icon (noun-safety-cone-6769739.svg), not a hand-drawn
 ...
 * guess, matching this file's move to real 1920×1080 coordinates. */
...
const ConeIcon = () => (
  <svg width={CONE_SIZE_PX * (110 / 135)} height={CONE_SIZE_PX} viewBox={CONE_VIEWBOX}>
